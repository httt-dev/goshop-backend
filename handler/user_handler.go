...
func (u UserHandler) GenAdminToken(c echo.Context) error  {
...
func (u UserHandler) HandlerAdminSignUp(c echo.Context) error  {
	tokenData := c.Get("user").(*jwt.Token)
	claims:= tokenData.Claims.(*model.JwtCustomClaims)
...
func (u UserHandler) HandlerAdminSignIn(c echo.Context) error  {
